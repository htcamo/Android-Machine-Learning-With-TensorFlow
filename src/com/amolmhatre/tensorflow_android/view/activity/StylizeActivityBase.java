 ...
 */
public class StylizeActivityBase extends BaseCameraActivity implements OnImageAvailableListener {
    ...
    private class ImageGridAdapter extends BaseAdapter {
...

        {
            final Button sizeButton =
                    new Button(StylizeActivityBase.this) {
                        @Override
            ...
            for (int i = 0; i < NUM_STYLES; ++i) {
                ...
                if (items[i] == null) {
                    final ImageSlider slider = new ImageSlider(StylizeActivityBase.this);
                    final Bitmap bm =
                            getBitmapFromAsset(StylizeActivityBase.this, "thumbnails/style" + i + ".jpg");
